  ...
  render: function() {
    ...
    return (    
      React.createElement('form', {className: 'ContactForm'},
        React.createElement('h1', {type: 'text', style: {float: "left", marginRight: "455px"}}, "Add Students"),  
  ...
  render: function() {
    ...
    return (
      React.createElement('div', {className: 'ContactView'},
        ...
        React.createElement('h1', {className: 'ContactView-title'}, "Students"),
...
// Set initial data
  State({
    ...
    newContact: {name: "", email: "", fullName: "", comment:"", key : ""},
  });
